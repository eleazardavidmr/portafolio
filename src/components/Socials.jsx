...
<svg className={styles.send_svg} xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-send-2" width="44" height="44" viewBox="0 0 24 24" stroke-width="1.5" stroke="#d1d5dc" fill="none" stroke-linecap="round" stroke-linejoin="round">
